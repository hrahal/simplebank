...
// Source: github.com/hrahal/simplebank/db/sqlc (interfaces: Store)
//
...
import (
	...
	sqlc "github.com/hrahal/simplebank/db/sqlc"
...
func (m *MockStore) DeleteEntries(ctx context.Context, id int64) error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "DeleteEntries", ctx, id)
	ret0, _ := ret[0].(error)
	return ret0
}

// DeleteEntries indicates an expected call of DeleteEntries.
func (mr *MockStoreMockRecorder) DeleteEntries(ctx, id any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "DeleteEntries", reflect.TypeOf((*MockStore)(nil).DeleteEntries), ctx, id)
}
...
func (m *MockStore) ListEntry(ctx context.Context, arg sqlc.ListEntryParams) ([]sqlc.Entries, error) {
	m.ctrl.T.Helper()
...
func (m *MockStore) UpdateAccounts(ctx context.Context, arg sqlc.UpdateAccountsParams) (sqlc.Accounts, error) {
	m.ctrl.T.Helper()
...
func (mr *MockStoreMockRecorder) UpdateAccounts(ctx, arg any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (m *MockStore) UpdateEntries(ctx context.Context, arg sqlc.UpdateEntriesParams) (sqlc.Entries, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "UpdateEntries", ctx, arg)
	ret0, _ := ret[0].(sqlc.Entries)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (mr *MockStoreMockRecorder) UpdateEntries(ctx, arg any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "UpdateEntries", reflect.TypeOf((*MockStore)(nil).UpdateEntries), ctx, arg)
}
